...
namespace Benchmarks
{
    public class SumTheWaterLevel
    {
        ...
        [Benchmark(Description = "Alt no activtor InfluxQL.net by gambrose")]
        public Task<double> alt_no_activator_by_gambrose()
        {
            return new InfluxDB.InfluxQL.BenchmarkSuite().SumTheWaterLevelAltNoActivator(endpoint, database);
        }
