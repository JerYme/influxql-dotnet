...
namespace InfluxDB.InfluxQL.StatementBuilders.SelectStatement
{
    public class Offset<TValues>
    {
        ...
        {
            Statement = new SingleSeriesSelectStatement<TValues>(statement.Select, statement.From, statement.Where, statement.GroupBy, statement.Limit, new OffsetClause(n));
        }
    ...
    public class Offset<TValues, TGroupBy>
    {
        ...
        {
            Statement = new MultiSeriesSelectStatement<TValues, TGroupBy>(statement.Select, statement.From, statement.Where, statement.GroupBy, statement.Limit, new OffsetClause(n));
        }
